        ...
        /* End of statement */
            ...
            if (esp_gps->crc == crc) {
                ...
                if (((esp_gps->parsed_statement) & esp_gps->all_statements) == esp_gps->all_statements) {
                	...
                	ESP_LOGD(GPS_TAG, "Some statements have not been parsed, esp_gps->parsed_statement: %d, esp_gps->all_statements: %ld", esp_gps->parsed_statement, esp_gps->all_statements);
